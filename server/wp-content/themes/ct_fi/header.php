        ...
        <![endif]-->
   		...
   		<div id="top">
			<div class="container">
				...
				<div id="language">
					<ul>
						<li class="active"><a href="<?php echo get_site_url(4); ?>"><div class="lang_icon fin"></div>FI<div id="arrow"></div></a></li>
						...
						<li class="last"><a href="<?php echo get_site_url(2); ?>"><div class="lang_icon eng"></div>EN</a></li>
					</ul>
				</div>
			</div>
		</div>
