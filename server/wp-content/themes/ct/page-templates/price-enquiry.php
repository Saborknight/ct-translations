...
?>
				<form id="price_check" method="post" action="" enctype="multipart/form-data">
					<input required type="text" class="price_request" name="client_name" placeholder="<?php _ex('Individual or Company Name', 'form-fields', 'ct'); ?>">
					<input required type="email" class="price_request" name="client_email" placeholder="<?php _ex('E-mail', 'form-fields', 'ct'); ?>">
					<input type="tel" class="price_request" name="client_phone" placeholder="<?php _ex('Phone No.', 'form-fields', 'ct'); ?>">
					...
					<input type="text" class="price_request" name="deadline" placeholder="<?php _ex('Due Date', 'form-fields', 'ct'); ?>">
					<textarea class="price_request description" name="description" placeholder="<?php _ex('Brief Outline of Subject Matter (incl. volume of material)', 'form-fields', 'ct'); ?>" style="resize: none;"></textarea>
					<h2><?php _ex('Attach File(s):', 'form-fields', 'ct'); ?></h2>
