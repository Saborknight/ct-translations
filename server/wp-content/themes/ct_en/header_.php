        ...
        <![endif]-->
   		...
   		<div id="top">
			<div class="container">
				...
				<div id="language">
					<ul>
						<li class="active"><a href="<?php echo get_site_url(2); ?>"><div class="lang_icon eng"></div>In English<div id="arrow"></div></a></li>
		...
		<div id="menu_area">
			<div class="container">
				...
				<form id="search" role="search" method="get" action="<?php echo home_url( '/' ); ?>">
					<input type="text" id="search-input" name="s" onfocus="if(this.value=='Search site')this.value=''" onblur="if(this.value=='')this.value='Search site'" value="Search site" />
