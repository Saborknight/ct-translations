        ...
        <![endif]-->
   		...
   		<div id="top">
			<div class="container">
				...
				<div id="language">
					<ul>
						<li class="active"><a href="<?php echo get_site_url(2); ?>"><div class="lang_icon eng"></div>EN<div id="arrow"></div></a></li>
						<li><a href="<?php echo get_site_url(1); ?>"><div class="lang_icon est"></div>ET</a></li>
